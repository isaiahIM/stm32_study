...
#define SERVO2_PIN (1<<1)// PB.1: SERVO2
#define SERVO3_PIN (1<<2)// PB.2: SERVO3
#define SERVO4_PIN (1<<3)// PB.3: SERVO4
#define SERVO5_PIN (1<<4)// PB.4: SERVO6
#define SERVO6_PIN (1<<5)// PB.5: SERVO6
#define SERVO7_PIN (1<<6)// PB.6: SERVO7
#define SERVO8_PIN (1<<7)// PB.7: SERVO8
...
void Init_GPIO(void)
{
	...
	(*(volatile unsigned int*)0X40010C00)|=0X33333333;// GPIOB->CRL|=0X33333333; << PORTB.0~7 INIT(OUTPUT, PUSH-PULL)
}
...
\*----------------------------------------------------------*/
int main (void) {
	int _servoPos[8]={0, 10, 20, 30, 40, 50, 60, 70};
	int _servoVelocity[8]={1, 7, 6, 5, 4, 3, 2, 1};
